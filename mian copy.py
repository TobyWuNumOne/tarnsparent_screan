...
tk.Label(root, text='目前時間', bg='#ffffff', fg="#000000", font=('Arial',80)).pack()   # 放入第一個 Label 標籤
tk.Label(root, bg='#ffffff', fg="#000000", textvariable=a, font=('Arial',80)).pack()   # 放入第二個 Label 標籤，內容是 a 變數
